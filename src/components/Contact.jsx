...
export default function Example() {
  ...
  return (<div >
    <div style={{background:'transparent',color:'white'}}  className='con'>
        <section style={{background:'transparent',color:'white'}} className="py-6 dark:bg-gray-100 dark:text-gray-900">
	<div style={{marginTop:'300px'}} className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
		...
		<div style={{height:'1000px',textAlign:'center',width:'700px',background:'transparent',color:'white'}} className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div
      ...
      <div className="fo">
      <div style={{position:'relative',bottom:'350px',color:'white'}} className="mx-auto max-w-2xl text-center">
        <h2 style={{color:'#00F7B8'}} className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Contact Us</h2>
       

      </div>
      <form  style={{background:'transparent',color:'white'}} action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <Field as="div" className="flex gap-x-4 sm:col-span-2">
            ...
            <Label   style={{marginLeft:'70px',color:'white',fontSize:'18px'}} className="text-sm leading-6 text-gray-600">
